...
# Top2：CLI 理性的浓度
对于命令行的了解非常不够，所以在看到命令行可以做到这么多事后觉得很酷炫，立志学好命令行！  
另外一点是大妈提到的命令行的使用是一种理性。去掉很多多余的东西，命令行所呈现看到的都是原始的信息，是本源。从根本上理解问题才能正确解决问题。
# Top3：官方文档DOC
遇到什么问题都可以先在官方文档里找，英文原版的。  
不过才知道文档可以下载到本地，[location](https://docs.python.org/2/download.html)
